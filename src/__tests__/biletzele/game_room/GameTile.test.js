import {doesNotExistInPendingGameMockedUser, pendingGame} from "../../mocks/GameMocks";
...
describe('<GameTile>', () => {
    test('choose team for me chooses the team with the smallest number of members', () => {
        let wrapper;
        act(() => {
            wrapper = render(<GameTile game={pendingGame} user={doesNotExistInPendingGameMockedUser}/>);
        });
